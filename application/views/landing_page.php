...
<html lang="en">
   <head>
      ...
      <title>Penggajian PT PELABUHAN TIGA BERSAUDARA</title>
      <!-- StyleSheets -->
   ...
   <body>
      ...
      <div class="Header" id="Home">
         <nav class="navbar fixed-top">
            <div class="container">
               <a class="navbar-brand" href="#">PT PELABUHAN TIGA BERSAUDARA</a>
               <div class="collapse_menu deactive">
                  ...
                  <ul class="nav">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="#Tentang">Mengenai Kami</a>
                     </li>
                     <li class="nav-item">
            ...
            <div class="content">
               <div class="row">
                  <div class="col-md-6 col-lg-4 col-xl-3 ">
                     <div class="card">
                        <div class="CardImage"><img src="<?php echo base_url(); ?>assets/img/tentang.png"></div>
                        <div class="body">
