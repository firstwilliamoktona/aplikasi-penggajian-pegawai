...
<html>
<head>
  <title>Login | Aplikasi Penggajian Karyawan PT PELABUHAN TIGA BERSAUDARA</title>
...
<body>
  <div class="container">
    <div class="img">
      <img src="<?php echo base_url(); ?>assets/img/payroll.jpg">
    </div>
    <div class="login-content">
      <form class="user" method="POST" action="<?php echo base_url('login') ?>">
        <img src="<?php echo base_url(); ?>assets/img/avatar.png">
        <h2 class="title">Aplikasi Penggajian PT Pelabuhan Tiga Bersaudara Dumai</h2>
